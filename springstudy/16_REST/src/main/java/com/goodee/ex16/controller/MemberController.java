...
public class MemberController {
	...
	public Map<String, Object> addMember(@RequestBody MemberDTO member, HttpServletResponse response) {	  // json 반환할 떈 Map이나 responseEntity
	...
	public Map<String, Object> changeMember(@RequestBody MemberDTO member, HttpServletResponse response) {	// response는 여기서 예외사항 처리를 위해 만듬. 아니면 안만듬.
